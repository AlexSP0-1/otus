...
int main(int, char **)
{
    ...
    using Matrix2D = SparseMatrix::SparseMatrix<int, 0>;
    ...
    std::cout << "----Optional task-----" << std::endl;

    const size_t SIZE4D = 4;

    using Matrix4D = SparseMatrix::SparseMatrix<int, 0, 4>;
    ...
    std::cout << std::endl
              << "Assignment concatenation: matrix4d[1][2][3][4] = 11 = 110 = 1110:" << std::endl
              << std::endl;

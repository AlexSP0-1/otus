...
{
    SparseMatrix::SparseMatrix<int, -1, 3> matrix;
...
{
    const size_t RANK = 4;
    SparseMatrix::SparseMatrix<int, -1, 4> matrix;
...
{
    SparseMatrix::SparseMatrix<int, 0> matrix;
...
{
    SparseMatrix::SparseMatrix<int, -999> matrix;
    size_t SIZE = 4;
...
{
    SparseMatrix::SparseMatrix<int, 0, 5> matrix;
...
{
    SparseMatrix::SparseMatrix<int, -99, 5> matrix;
